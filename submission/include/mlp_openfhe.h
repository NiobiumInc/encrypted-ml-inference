...
//
// HEIR v2 model header — 2-layer MLP (784→512→10) with runtime weight loading.
// Used by all instance sizes (ring 2^16, FPGA).
//
// NOTE: This header defines CiphertextT as mutable Ciphertext<DCRTPoly>.
// Do NOT include both this header and mlp_encryption_utils.h in the same translation unit.
